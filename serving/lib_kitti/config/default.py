...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = "/opt/ml/YOLOP_kitti/runs/BddDataset/model_best_train_da_only.pth" # trained parameter /opt/ml/final-project-level3-cv-08/YOLOP/weights/End-to-end.pth
