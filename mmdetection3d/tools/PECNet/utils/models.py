...
class PECNet(nn.Module):
    ...
    def __init__(self, enc_past_size, enc_dest_size, enc_latent_size, dec_size, predictor_size, non_local_theta_size, non_local_phi_size, non_local_g_size, fdim, zdim, nonlocal_pools, non_local_dim, sigma, past_length, future_length, verbose=True):
        '''
        Args:
        ...
        #self.predictor = MLP(input_dim = 2*fdim + 2, output_dim = future_length, hidden_size=predictor_size)
