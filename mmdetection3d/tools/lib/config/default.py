...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = "/opt/ml/final-project-level3-cv-08/YOLOP_kitti/runs/BddDataset/model_best_train_all.pth" # trained parameter /opt/ml/final-project-level3-cv-08/YOLOP/weights/End-to-end.pth
...
"""_C.DATASET.DATAROOT = '/opt/ml/kitti_for_yolop/image'       # the path of images folder
_C.DATASET.LABELROOT = '/opt/ml/kitti_for_yolop/label'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/opt/ml/kitti_for_yolop/seg'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/opt/ml/kitti_for_yolop/lane'         # the path of ll_seg_annotations folder"""
